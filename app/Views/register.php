    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="<?= base_url('register') ?>" method="post">
                ...
                <div class="form-floating">
                    <input name="latitude" type="text" class="form-control" id="latitudeInput" placeholder="Latitude">
                    <label for="latitudeInput">Latitude</label>
                </div>
                <div class="form-floating">
                    <input name="longitude" type="text" class="form-control" id="longitudeInput" placeholder="Longitude">
