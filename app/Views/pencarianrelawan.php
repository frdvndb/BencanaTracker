...
<?php
            $daftarnama = array(
              array("nama" => "Andra", "gambar" => "/assets/img/2.jpg"),
              array("nama" => "Farid", "gambar" => "/assets/img/2.jpg"),
              array("nama" => "Azhar", "gambar" => "/assets/img/2.jpg"),
              array("nama" => "Ajai", "gambar" => "/assets/img/2.jpg"),
              array("nama" => "Wawan", "gambar" => "/assets/img/2.jpg"),
            );
